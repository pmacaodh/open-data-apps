...
origins = ['Baden','Spreitenbach','Dietikon','Schlieren','Altstetten',
           'Watt','Regensdorf','Affoltern','Dielsdorf',
           'Oerlikon', 'Opfikon','Kloten','Bülach',
           'Wallisellen', 'Brüttisellen', 'Effretikon','Winterthur',
           'Dübendorf','Volketswil','Uster',
           'Zollikon', 'Küsnacht','Meilen',
           'Kilchberg','Thalwil','Horgen','Wädenswil',
           'Adliswil','Zug',
